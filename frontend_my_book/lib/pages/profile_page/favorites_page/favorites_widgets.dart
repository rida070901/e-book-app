...
Widget buildFavoriteListItem(LoadedFavoritesState state){
    ...
    child: ListView.builder(
        ...
        itemBuilder: (context, index){
          ...
          return CachedNetworkImage(
              imageUrl: "${AppConstants.SERVER_UPLOADS}${state.bookItem[index].thumbnail!}",
              ...
              imageBuilder: (context, imageProvider){
                return Container(
                  ...
                  child: InkWell(
                    onTap: () {
                      //print("------------passing id ${state.bookItem.elementAt(index).id}");
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          width: 55.w,
                          child: Text(
                            "\$${state.bookItem[index].price.toString()??""}",
                            maxLines: 1,
                            style: TextStyle(
...
Widget buildFavoriteBooksList(LoadedFavoritesState state) {
  return SingleChildScrollView(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                fit: BoxFit.fitHeight,
                                image: NetworkImage("${AppConstants.SERVER_UPLOADS}${state.bookItem[index].thumbnail!}"))),
                      ),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        mainAxisAlignment: MainAxisAlignment.center,
